...
//
//	mockgen -source=rxbytes.go -destination=../../../test/mocks/gomock/homeassistant/rxbytes/rxbytes.go
//
// Package mock_rxbytes is a generated GoMock package.
package mock_rxbytes
